...
const links = [
 { path: '/log', label: '로그 모니터링&제어', subLinks: [] },
  ...
  { path: '/test/manual/pattern', label: '불량화소 검출' ,subLinks: [] },
  ...
  { path: '/test/auto/pattern/uniformity', label: '균일도 테스트' , subLinks: [] },
  { path: '/test/manual/contrastratio', label: '명암비테스트' ,subLinks: [] },
  { path: '/test/auto/whitebalance', label: '화이트밸러스' ,subLinks: [] },
