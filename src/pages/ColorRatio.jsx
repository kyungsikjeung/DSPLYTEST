      ...
      <div className="max-w-4xl mx-auto bg-blue-50 p-10 rounded-lg shadow-lg">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            디스플레이의 계조(Gray scale) 표현 정확도를 검증하기 위해 R/G/B/Gray 단계별 밝기 차이를 측정하여 계조 특성을 평가하고, 저휘도(0~50)나 고휘도(200 이상)와 같은 특정 영역을 선택해 사용자 맞춤 검증을 수행하기 위함입니다. 또한 측정된 색 좌표(u′, v′)를 활용하여 색상 균형과 불량 색상 여부를 정밀하게 판정함으로써, 단순 밝기 검증을 넘어 색상 재현성과 품질 신뢰성까지 확보할 수 있습니다.
          </p>
        </section>
